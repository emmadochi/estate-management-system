...
if (!isset($pageTitle) || trim((string)$pageTitle) === '') {
    $pageTitle = 'Artisan Area – EstatePro';
}
...
function _artisan_nav_active(string $file, string $current): string {
              ...
              <div class="app-header-menu app-header-mobile-drawer align-items-stretch"
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                  <div class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                    <a class="menu-link" href="dashboard.php"><span class="menu-title">Artisan Area</span></a>
                  </div>
                </div>
              </div>
              ...
              <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
                <div id="kt_app_sidebar_menu_scroll" class="hover-scroll-y my-5 mx-3"
                  ...
                  <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold" id="kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    <div class="menu-item">
                      <a class="menu-link<?= _artisan_nav_active('dashboard.php', $current) ?>" href="dashboard.php">
                    ...
                    <div class="menu-item">
                      <a class="menu-link<?= _artisan_nav_active('tickets.php', $current) ?>" href="tickets.php">
                    ...
                    <div class="menu-item">
                      <a class="menu-link<?= _artisan_nav_active('payment_confirmation.php', $current) ?>" href="payment_confirmation.php">
                    ...
                    <div class="menu-item px-3">
                      <div class="text-gray-600 fs-8">Vendor</div>
                      <div class="fw-bold text-gray-900"><?= e($vendor['name'] ?? '') ?></div>
